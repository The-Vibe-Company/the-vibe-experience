...
Ensuite, quand tu l'utilises, la preuve qu'il tourne vraiment, c'est la ligne au nom du skill (du genre « Ran skill /create-skill-tools ») qui s'affiche. Si elle n'apparaît pas, ferme et rouvre Claude Code puis redemande.
