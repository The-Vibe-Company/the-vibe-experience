  ...
  },
  {
    ...
    sous: [
      ...
      },
      {
        ...
        ceQueTuDoisVoir:
          "Avant d'agir, Claude Code te demande souvent la permission : une petite fenêtre en anglais (capture ci-dessous) avec l'action qu'il veut lancer et trois boutons, « Allow once » (autoriser une fois), « Always allow » (toujours autoriser) et « Deny » (refuser). C'est normal, et c'est toi le chef : clique « Allow once » pour le laisser travailler. Ensuite, du texte se met à défiler tout seul : l'IA t'explique ce qu'elle fait et crée des fichiers. Ça peut prendre plusieurs minutes, parfois cinq à dix la première fois (elle télécharge tout ce qu'il faut) : tant que ça bouge, c'est bon signe. Ne ferme pas la fenêtre pendant ce temps.",
        visuel: {
          src: "/module/1-2-allow-deny.png",
          alt: "La fenêtre de permission de Claude Code : « Allow Claude to write test.txt? », le fichier concerné, et les boutons Deny, Always allow et Allow once.",
  ...
  },
  {
    ...
    sous: [
      ...
      },
      {
        ...
        ceQueTuDoisVoir:
          "Quand le skill part, une ligne au nom du skill (du genre « Ran skill /impeccable ») s'affiche dans la conversation : c'est ta preuve qu'il tourne. À l'écran du site, souvent presque aucune différence, et c'est normal : le travail se passe dans les coulisses, sur le code.",
        siCaBloque:
    ...
    sous: [
      ...
      },
      {
        ...
        pasAPas: [
          ...
          "Crée ensuite un projet (bouton « New project ») : donne-lui un nom, note quelque part le mot de passe de base de données qu'il te demande, et choisis une région en Europe. Un écran d'attente tourne ensuite une à deux minutes pendant qu'il prépare ta base, c'est normal, ne recharge pas la page.",
